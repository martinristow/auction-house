...
# config.set_main_option("sqlalchemy.url",
#                        f'postgresql+psycopg2://{quote(settings.database_username)}:{quote(settings.database_password)}@{quote(settings.database_hostname)}:{quote(settings.database_port)}/{quote(settings.database_name)}')
